...
if [ -f .env ]; then
  while IFS='=' read -r key rest; do
    case "$key" in
      ANTHROPIC_API_KEY|OPENAI_API_KEY|LLM_PROVIDER|PREFERRED_LLM|OPENAI_MODEL|ANTHROPIC_MODEL|MODEL_ROUTER_DEFAULT_MODEL|DEEPGRAM_API_KEY|ELEVENLABS_API_KEY|ELEVENLABS_VOICE_ID|ELEVENLABS_MODEL_ID|ASSEMBLYAI_API_KEY)
