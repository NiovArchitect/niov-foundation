...
export const SCHEMA_MANIFEST: TableRequirement[] = [
  ...
  {
    // SECTION-10 ORG-TRUTH — promoted organizational-truth records. Runtime-critical columns only.
    table: "org_truth_records",
    columns: [
      { name: "truth_record_id", dataType: "uuid", notNull: true },
      { name: "org_entity_id", dataType: "uuid", notNull: true },
      { name: "decision_domain", dataType: "text", notNull: true },
      { name: "truth_key", dataType: "text", notNull: true },
      { name: "state", dataType: "text", notNull: true },
      { name: "version", dataType: "integer", notNull: true },
      { name: "winning_source_record_id", dataType: "uuid" },
      { name: "promotion_evidence_snapshot_id", dataType: "uuid" },
      { name: "supersedes_truth_record_id", dataType: "uuid" },
      { name: "superseded_by_truth_record_id", dataType: "uuid" },
      { name: "conflict_set_ref", dataType: "uuid" },
      { name: "value", dataType: "jsonb", notNull: true },
      { name: "metadata", dataType: "jsonb", notNull: true },
      { name: "visibility_scope", dataType: "text", notNull: true },
      { name: "origin_key", dataType: "text" },
      { name: "created_at", dataType: "timestamp without time zone", notNull: true },
  ...
  {
    table: "org_truth_conflict_sets",
    columns: [
      { name: "conflict_set_id", dataType: "uuid", notNull: true },
      { name: "org_entity_id", dataType: "uuid", notNull: true },
      { name: "truth_key", dataType: "text", notNull: true },
      { name: "decision_domain", dataType: "text", notNull: true },
      { name: "state", dataType: "text", notNull: true },
      { name: "version", dataType: "integer", notNull: true },
      { name: "review_obligation_id", dataType: "uuid" },
      { name: "candidate_set_fingerprint", dataType: "text" },
      { name: "resulting_truth_record_id", dataType: "uuid" },
      { name: "origin_key", dataType: "text" },
      { name: "created_at", dataType: "timestamp without time zone", notNull: true },
      { name: "updated_at", dataType: "timestamp without time zone", notNull: true },
    ],
  ...
  {
    table: "org_truth_conflict_candidates",
    columns: [
      { name: "candidate_id", dataType: "uuid", notNull: true },
      { name: "conflict_set_id", dataType: "uuid", notNull: true },
      { name: "org_entity_id", dataType: "uuid", notNull: true },
      { name: "source_record_type", dataType: "text", notNull: true },
      { name: "source_record_id", dataType: "uuid", notNull: true },
      { name: "permission_eligible", dataType: "boolean", notNull: true },
      { name: "is_winner", dataType: "boolean", notNull: true },
      { name: "created_at", dataType: "timestamp without time zone", notNull: true },
    ],
    uniques: [{ columns: ["conflict_set_id", "source_record_type", "source_record_id"] }],
  },
];
