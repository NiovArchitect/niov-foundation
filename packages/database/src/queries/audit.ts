...
export type AuditEventType =
  ...
  // [OTZAR-RETURN-12-FOUNDATION] governed voice-note undo apply: a summary,
  // SAFE-details audit emitted once per apply that actually soft-revokes
  ...
  // [OTZAR STAGE-2 TRUTH-EVIDENCE] Point-in-time evidence-snapshot lifecycle. Leak-safe only.
  | "TRUTH_EVIDENCE_SNAPSHOT_CAPTURED"
  | "TRUTH_EVIDENCE_CHANGED"
  | "TRUTH_EVIDENCE_CONFLICT_DETECTED"
  | "TRUTH_EVIDENCE_RECHECK_REQUIRED"
  | "TRUTH_EVIDENCE_RECHECKED"
  | "TRUTH_EVIDENCE_SUPERSEDED"
  // [SECTION-10 ORG-TRUTH] Governed organizational-truth promotion + conflict lifecycle. Leak-safe.
...
export const AUDIT_EVENT_TYPE_VALUES = [
  ...
  "HANDOFF_OBLIGATION_LINKED",
  "HANDOFF_OBLIGATION_DISPOSED",
  // [OTZAR STAGE-2 TRUTH-EVIDENCE] Evidence-snapshot lifecycle (kept in sync with the union).
  "TRUTH_EVIDENCE_SNAPSHOT_CAPTURED",
  "TRUTH_EVIDENCE_CHANGED",
  "TRUTH_EVIDENCE_CONFLICT_DETECTED",
  "TRUTH_EVIDENCE_RECHECK_REQUIRED",
  "TRUTH_EVIDENCE_RECHECKED",
  "TRUTH_EVIDENCE_SUPERSEDED",
  // [SECTION-10 ORG-TRUTH] Promotion + conflict lifecycle (kept in sync with the union).
  "ORG_TRUTH_CANDIDATE_SUBMITTED",
  "ORG_TRUTH_CONFLICT_OPENED",
  "ORG_TRUTH_CONFLICT_UPDATED",
  "ORG_TRUTH_PROMOTED",
