...
- **Foundation main HEAD:** `a3e21e1` (ADR-0082 Dandelion Activation PR #174 LIVE; **ADR-0083 Section 8 Billing/Entitlements in flight**). **CT main HEAD:** `bf7f826` (Wave 6 CT surface LIVE). Sections 5 + 7 + 9 Approvals + 9 Policies remain PRODUCTION-GRADE COMPLETE. **ADR-0080 Wave 2.1 LIVE** + **ADR-0081 Workflows Doctrine LIVE** + **ADR-0082 Dandelion Activation Architecture LIVE** + **ADR-0083 Section 8 Billing/Entitlements LANDED** (design-only; $250 base + add-ons; 10 non-negotiable billing governance posture rules; security/governance never unsafe-paywalled; payment provider deferred to B3 ADR). Wave 6 + Section 10 ops + Wave 3 all LIVE. Section 8 Billing blocker closed at the **doctrine register**; per-seat / per-pack USD pricing requires explicit Founder decision at B2.
- **Latest merged PR (Foundation):** [#174](https://github.com/NiovArchitect/niov-foundation/pull/174) — ADR-0082 Dandelion Activation Architecture. **Latest CT PR:** [#19](https://github.com/NiovArchitect/otzar-control-tower/pull/19) — Wave 6 surface LIVE.
