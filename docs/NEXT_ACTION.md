...
- **Active branch / PR:** `section-5-wave-7-option-a-closeout-docs` (Wave 7 closeout docs).
...
- **Section 5 Wave 8 governed-transition contract ADR (ADR-0075)** — design-only, per ADR-0065 §7 + ADR-0074 §20 + Founder autonomy directive. Locks how a Wave 7 recommendation is translated into a proposed Action plan submitted to Section 2 Action runtime per ADR-0057; routes through policy + scoped permissions + approvals + audit + dual-control where required; NO automatic execution; NO bypass of Section 2.
