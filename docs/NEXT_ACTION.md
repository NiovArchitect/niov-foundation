...
- **Foundation main HEAD:** `175f413` (ADR-0083 Amendment 1 PR #176 LIVE; **ADR-0082 Amendment 1 cartographer doctrine in flight**). **CT main HEAD:** `bf7f826` (Wave 6 CT surface LIVE). Sections 5 + 7 + 9 Approvals + 9 Policies remain PRODUCTION-GRADE COMPLETE. **ADR-0080 Wave 2.1 LIVE** + **ADR-0081 Workflows Doctrine LIVE** + **ADR-0082 Dandelion Activation Architecture LIVE** + **ADR-0083 base + Amendment 1 LIVE** + **ADR-0082 Amendment 1 LANDED** (Dandelion-as-organizational-cartographer doctrine; 8 canonical lines; 9 Map Types; allowed/forbidden UI language; Admin Twin cartographer-aware synthesis; 7 Wave 2.1 role-depth files touched with §30 Dandelion Map Implications). Canonical: *"Dandelion maps the territory. Admins approve the map. Foundation governs what can happen inside the map. DMWs scope what can be remembered. Digital Twins operate within the approved terrain."* Next: ADR-0084 Section 4 MCP/Connector Strategy.
- **Latest merged PR (Foundation):** [#176](https://github.com/NiovArchitect/niov-foundation/pull/176) — ADR-0083 Amendment 1 Billing Expansion. **Latest CT PR:** [#19](https://github.com/NiovArchitect/otzar-control-tower/pull/19) — Wave 6 surface LIVE.
