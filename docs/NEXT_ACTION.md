...
- **Foundation main HEAD:** `9d9de49` (Wave 2.1 role-depth PR #172 LIVE; **ADR-0081 Workflows Doctrine in flight**). **CT main HEAD:** `bf7f826` (Wave 6 CT surface LIVE). Sections 5 + 7 + 9 Approvals + 9 Policies remain PRODUCTION-GRADE COMPLETE. **ADR-0080 Wave 2.1 LIVE** (21 role-depth Markdown files; Otzar Admin first-class; Admin Twin = first DGI champion). **ADR-0081 Section 9 Workflows Doctrine LANDED** (design-only; 5 maturity stages; Admin workflows first-class; CT `/workflows` Placeholder disposition canonical). Canonical framing locked: *"A workflow in Otzar is a governed, role-aware process that turns context into coordinated action through people, Digital Twins, tools, approvals, audit, and memory — without bypassing human authority."* Wave 6 + Section 10 ops + Wave 3 all remain LIVE. Remaining hard blockers: Section 8 Billing + Section 4 first-adapter (both Founder-decision-gated).
- **Latest merged PR (Foundation):** [#172](https://github.com/NiovArchitect/niov-foundation/pull/172) — Wave 2.1 role-depth Markdown layer. **Latest CT PR:** [#19](https://github.com/NiovArchitect/otzar-control-tower/pull/19) — Wave 6 surface LIVE.
