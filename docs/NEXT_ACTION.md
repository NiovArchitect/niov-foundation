...
- **Active branch / PR (Foundation):** `foundation-closeout-ct-invoke-connector-surface` — Classification A docs-only closeout recording 6/6 OPERATING matrix operator-usability graduation (CT PR #32 LIVE; CT main `de77cdf`).
