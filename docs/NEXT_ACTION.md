...
- **Foundation main HEAD:** `4b3265d` (ADR-0083 base PR #175 LIVE; **ADR-0083 Amendment 1 billing expansion in flight**). **CT main HEAD:** `bf7f826` (Wave 6 CT surface LIVE). Sections 5 + 7 + 9 Approvals + 9 Policies remain PRODUCTION-GRADE COMPLETE. **ADR-0080 Wave 2.1 LIVE** + **ADR-0081 Workflows Doctrine LIVE** + **ADR-0082 Dandelion Activation Architecture LIVE** + **ADR-0083 base LIVE** + **ADR-0083 Amendment 1 LANDED** (Professional Twin tier NEW; 8 connector pack families; 4 plan archetypes; Billing Admin role; 8 conceptual entitlement objects; DMW baseline included reinforced; 13-item cannot-be-unsafely-paywalled list; revised B1-B8 ladder front-loading static catalog before runtime). NEW `docs/current-build-state/08-billing-entitlements.md`. Section 8 doctrine register closed. Next: ADR-0084 Section 4 MCP/Connector Strategy.
- **Latest merged PR (Foundation):** [#175](https://github.com/NiovArchitect/niov-foundation/pull/175) — ADR-0083 Section 8 Billing/Entitlements. **Latest CT PR:** [#19](https://github.com/NiovArchitect/otzar-control-tower/pull/19) — Wave 6 surface LIVE.
