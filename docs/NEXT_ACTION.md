...
- **Foundation main HEAD:** `ac033de` (ADR-0081 Workflows Doctrine PR #173 LIVE; **ADR-0082 Dandelion Activation Architecture in flight**). **CT main HEAD:** `bf7f826` (Wave 6 CT surface LIVE). Sections 5 + 7 + 9 Approvals + 9 Policies remain PRODUCTION-GRADE COMPLETE. **ADR-0080 Wave 2.1 LIVE** + **ADR-0081 Workflows Doctrine LIVE** + **ADR-0082 Dandelion Activation Architecture LANDED** (design-only; 6 stages A-F; 6 layers L1-L6; Admin Dandelion path first-class; distinct from existing `dandelion.service.ts` per RULE 9/13). Canonical framing locked: *"Dandelion produces proposed maps. Foundation turns approved maps into governed capability."* Wave 6 + Section 10 ops + Wave 3 all remain LIVE. Remaining hard blockers: Section 8 Billing + Section 4 first-adapter (both Founder-decision-gated).
- **Latest merged PR (Foundation):** [#173](https://github.com/NiovArchitect/niov-foundation/pull/173) — ADR-0081 Workflows Doctrine. **Latest CT PR:** [#19](https://github.com/NiovArchitect/otzar-control-tower/pull/19) — Wave 6 surface LIVE.
