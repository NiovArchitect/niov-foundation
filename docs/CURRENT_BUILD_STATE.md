...
(**Section 6 Wave 6 LANDED 2026-05-30** — PR #117 `2c4336a`
ships NEW `POST /api/v1/analytics/action-runtime-by-action-type`
...
- **Latest main HEAD:** `2c4336a` (Section 6 Wave 6 per-ActionType action-runtime health; closeout docs PR pending)
