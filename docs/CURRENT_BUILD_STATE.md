...
- **Latest main HEAD:** `80a60f1` (Section 5 Wave 7 Option A deterministic / template-first TypeScript best-path-recommendation implementation landed).
