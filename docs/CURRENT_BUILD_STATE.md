...
(**Section 5 Wave 4 LANDED — Agent Playground persistent named
scenarios** per ADR-0065 §7. PR #111 ships
...
- **Latest main HEAD:** `a2988ee` (Section 5 Wave 4 — Agent Playground persistent named scenarios; closeout docs PR pending)
...
- **Active branch / PR:** `section-5-wave-4-closeout-docs` (Section 5 Wave 4 closeout docs; design-only).
