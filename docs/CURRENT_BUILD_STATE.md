...
(**Section 1 Wave 6B IMPLEMENTATION LANDED 2026-05-31** —
...
- **Latest main HEAD:** `625ddbf` (Section 1 Wave 6B priming-hook impl; closeout docs PR pending)
...
|---|---|---|
| [#124](https://github.com/NiovArchitect/niov-foundation/pull/124) | `625ddbf` | Add Section 1 Wave 6B — symbiotic accepted-pattern priming hook into assembleContext (14 tests) |
| [#123](https://github.com/NiovArchitect/niov-foundation/pull/123) | `14083c7` | Add Section 1 Wave 6B ADR-0067 — design-only |
