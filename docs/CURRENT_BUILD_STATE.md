...
- **Latest main HEAD:** `7593e6f` (Wave 9 vNext runtime LIVE 2026-05-31; clean v1 → vNext replacement per ADR-0076 §17A; 51 Wave 9 integration tests passing). Wave 10 vNext lockstep LIVE in `otzar-control-tower` at HEAD `ff6e54b` (PR #7 merged 2026-05-31; 110/110 CT tests passing).
- **Latest merged PR:** [#152](https://github.com/NiovArchitect/niov-foundation/pull/152) — Migrate Wave 9 simulation runtime from v1 vocabulary to ADR-0076 §4.2 + §5.2 vNext vocabulary (clean replacement; 51 integration tests).
- **Active branch / PR:** `section-5-wave-9-vnext-closeout-docs` (Wave 9 vNext runtime + Wave 10 lockstep closeout docs refresh).
