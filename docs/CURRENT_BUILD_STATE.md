...
- **Latest main HEAD:** `11b80cb` (ADR-0072 Section 5 Wave 5 candidate-generation contract ADR design-only landed).
...
- **Section 1 status:** PRODUCTION-GRADE COMPLETE for v1 Foundation drift-detection backend scope. Section 6 PRODUCTION-GRADE COMPLETE earlier 2026-05-30. Section 3 PRODUCTION-GRADE COMPLETE earlier 2026-05-30. **Section 5 PARTIAL with Waves 1+2+3+4 LIVE + Wave 5 contract ADR-0072 LANDED design-only 2026-05-31** (Wave 4 LANDED 2026-05-30; Wave 5 implementation slice is forward-substrate behind separate Founder authorization).
...
| [#133](https://github.com/NiovArchitect/niov-foundation/pull/133) | `6ab71e9` | Close out ADR-0071 cross-scope verify-chain implementation — Section 7 4 read shapes × 4 scopes LIVE |
...
| [#122](https://github.com/NiovArchitect/niov-foundation/pull/122) | `c6c2501` | Close out Section 1 Wave 6A — symbiotic advisory surface docs |
