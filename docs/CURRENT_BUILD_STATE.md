...
- **Latest main HEAD:** `692f124` (PR #220 W4 Proposed Action substrate LIVE 2026-06-02). **CT main HEAD:** `de77cdf` (CT PR #32 INVOKE_CONNECTOR CT surface LIVE 2026-06-02 — 6/6 OPERATING connector matrix now operator-usable from Control Tower).
- **Latest merged PR:** [#220](https://github.com/NiovArchitect/niov-foundation/pull/220) — W4 Proposed Action Substrate per ADR-0081 §2.2 Stage 3 (docs-only).
- **Active branch / PR:** `foundation-closeout-ct-invoke-connector-surface` — docs-only closeout recording CT INVOKE_CONNECTOR surface graduation.
