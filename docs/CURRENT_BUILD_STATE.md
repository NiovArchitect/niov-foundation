...
- **Latest main HEAD:** `8a69863` (Section 5 Wave 8 Option A deterministic governed-transition implementation landed; Wave 9 contract ADR-0076 design-only forward-queued in active branch).
...
- **Active branch / PR:** `section-5-wave-8-closeout-plus-wave-9-contract-adr` (combined Wave 8 closeout docs + Wave 9 contract ADR-0076 design-only).
