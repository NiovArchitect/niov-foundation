...
(**Section 1 Wave 5 ADR-0066 LANDED design-only** —
...
- **Latest main HEAD:** `dbbe9c7` (Section 5 Wave 4 closeout docs)
- **Latest merged PR:** [#112](https://github.com/NiovArchitect/niov-foundation/pull/112) — Section 5 Wave 4 closeout docs.
- **Active branch / PR:** `section-1-wave-5-adr-otzar-proposed-pattern` (Section 1 Wave 5 ADR-0066 design-only).
