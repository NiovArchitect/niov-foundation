...
- **Latest main HEAD:** `26ec1dc` (PR #223 ADR-0087 + APPROVAL_BACKLOG Hive Intelligence Runtime V1 LIVE 2026-06-02). **CT main HEAD:** `de77cdf` (CT PR #32 INVOKE_CONNECTOR CT surface LIVE 2026-06-02 — 6/6 OPERATING connector matrix operator-usable from Control Tower). LEI sequence per `[FOUNDER-AUTH — W5 + LIVING ENTERPRISE INTELLIGENCE AUTONOMOUS BUILD]`: W5 ✅ (PR #222 ADR-0086) + Hive Intelligence Runtime V1 ✅ (PR #223 ADR-0087); next: Enterprise Communication Intelligence Layer (architecture/readiness ADR-first per RULE 21).
- **Latest merged PR:** [#223](https://github.com/NiovArchitect/niov-foundation/pull/223) — Hive Intelligence Runtime V1: ADR-0087 + APPROVAL_BACKLOG signal (first canonical Hive Intelligence Runtime signal; same-org EscalationRequest pending-rate aggregate over window with k=5 minimum-population gate + 6 closed-vocab labels + no new audit literal + no schema migration).
- **Active branch / PR:** `foundation-closeout-w5-plus-hive-intelligence-runtime-v1` — combined docs-only closeout recording W5 Action Promotion Runtime + Hive Intelligence Runtime V1 LEI sequence steps complete.
