...
- **Latest main HEAD:** `eba1e3a` (ADR-0077 Wave 10 Control Tower consumer-experience contract design-only LIVE 2026-05-31). Wave 10 implementation slice LIVE in `otzar-control-tower` at HEAD `cf3483f` (PR #6 merged 2026-05-31).
- **Latest merged PR:** [#149](https://github.com/NiovArchitect/niov-foundation/pull/149) — Add ADR-0077 design-only — Section 5 Wave 10 Agent Playground Control Tower consumer-experience contract.
