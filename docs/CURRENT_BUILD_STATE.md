...
- **Latest main HEAD:** `a1b7ca4` (Section 1 Wave 5 closeout docs)
- **Latest merged PR:** [#115](https://github.com/NiovArchitect/niov-foundation/pull/115) — Section 1 Wave 5 closeout docs.
- **Active branch / PR:** `section-7-rule13-regulator-expiry-doc-drift-fix` (RULE 13 substrate-honest docs-only correction; Hardening Wave D emitter has been LIVE since 2026-05-29 but was still listed as forward-substrate in Section 7 docs).
