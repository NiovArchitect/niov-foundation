...
- ADDENDUM-DMW-SLM (`docs/architecture/addendum-dmw-slm-equivalence.md`; landed in `[ADDENDUM-DMW-SLM]` `67fb083` on 2026-05-11) — articulates the inference-tier consequence of this RAA's substrate (a DMW under continuous COSMP feedback-loop operation becomes an emergent SLM-equivalent contextual inference surface; a DMW federation under hive composition becomes an emergent LLM-equivalent computational surface — "equivalent" denoting inference characteristics, not transformer architecture). The addendum introduces no new patent claims; it canonicalizes the consequence already implicit in the US 12,164,537 / US 12,399,904 / US 12,517,919 patent family for prior-art posture protection. §5 of the addendum substantiates the audit-lineage + permission-governed-composition framing that §5.2 of this RAA describes at runtime register (the [D-2D-D10-5] service-tier + [D-2D-D10-7] route-tier substantiation events); §3 substantiates the "confidence accumulation" threshold criterion (the [D-2D-D10-6] correction-propagation substantiation). RULE 14 back-citation landed at `[D-2D-D10-8]` (deferred from the addendum commit per the Sub-box-1 closure-amendment grouping).
