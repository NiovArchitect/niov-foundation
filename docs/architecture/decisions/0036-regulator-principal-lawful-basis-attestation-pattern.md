...
- ADR-0070 (Regulator-Ready Foundation Doctrine — Examination-Ready Evidence Flows; doctrine-ADR landed 2026-05-31) — load-bearing: ADR-0070 canonicalizes Foundation's regulator-readiness doctrine at the architectural-lens register. ADR-0036's REGULATOR Principal + LawfulBasis substrate (EntityType.REGULATOR + 3 TAR fields + LawfulBasis Prisma model + 6 LawfulBasisType values + 3 audit literals + 9-condition COSMP enforcement + canonical_record positions 13 + 14 cryptographic binding + dual-control bindings) is named at ADR-0070 §3.10 + §5.H as the canonical foundational substrate the broader regulator-ready product surface (Examination Room / Evidence Package / Project Provenance Ledger / Disclosure Trigger Engine / Regulator Update Workflow / Legal Hold / Supervisory Review Console / Regulator Access Governance / Regulatory Obligation Mapping / Compliance Evidence Vault) will compose against. ADR-0070 does NOT modify or supersede ADR-0036; ADR-0036 remains the canonical REGULATOR + LawfulBasis contract.
- ADR-0071 (Section 7 Cross-Scope Audit Verify-Chain Design; design-only ADR landed 2026-05-31) — load-bearing: ADR-0071 §2 regulator scope inherits ADR-0036's 9-condition LawfulBasis enforcement verbatim (lawful_basis_id REQUIRED + LAWFUL_BASIS_NOT_FOUND / LAWFUL_BASIS_EXPIRED / REGULATOR_TARGET_MISMATCH failure codes + jurisdiction / authority / data-class checks). The canonical_record positions 13 + 14 byte-equivalent binding + lawful_basis_chain_hash content-commitment hash from ADR-0036 §Sub-decision 5 become the cryptographic substrate ADR-0071 verify-chain consumes for regulator-scope continuity verification. ADR-0071 does NOT modify or supersede ADR-0036; ADR-0036's REGULATOR + LawfulBasis contract stays canonical.
